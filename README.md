...
- [pokajan-tools/](pokajan-tools/) — サイト本体には含めない運用ツール（再生数更新スクリプト、更新用プロンプト）置き場。APIキーを含むため公開フォルダの外に配置。
...
<!-- redeploy: guidelabo.com 接続直後のCDNキャッシュ不整合を解消するための再デプロイ 2026-08-09T14:54:58Z -->
